...
function main
{
	...
	echo DEBUG ANSI
	buildlib "-g -fPIC -Wall -Wno-unknown-pragmas" build/ansidebug libsyscommond.a
	echo
	
	echo RELEASE ANSI
	buildlib "-O2 -fPIC -Wall -Wno-unknown-pragmas" build/ansirelease libsyscommon.a
	echo
	
	echo DEBUG UNICODE
	buildlib "-g -fPIC -Wall -Wno-unknown-pragmas -DUNICODE" build/unicodedebug libsyscommonud.a
	echo
	
	echo RELEASE UNICODE
	buildlib "-O2 -fPIC -Wall -Wno-unknown-pragmas -DUNICODE" build/unicoderelease libsyscommonu.a
	echo
